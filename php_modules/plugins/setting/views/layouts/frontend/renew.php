          ...
          <tr>
            ...
            <td valign="top"><table width="100%" height="50" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="60%" valign="bottom"><div align="center">
                  </div>
                </td>
              </tr>
            </table></td>
          ...
          <tr>
            <td valign="top"><div align=center>
              <table width="100%" border="0" cellspacing="0" cellpadding="20">
                <tr>
                  <td><div align="center" class="hdrmain">
...
if ($this->err_flg != "OK")
  ...
  if ($this->data['s_type'] == "home")
    {
    echo "<tr><td width='49%' align='right' class='subbld' height='50'><b>email Address of User: &nbsp; </b></td><td>&nbsp;</td>\n";
    }
  elseif ($this->data['s_type'] == "teacher")
    {
  ...
  echo '<td width="49%" align="left" height="50"><input type="text" name="nu_email" value="' . $this->data['u_email'] . '" size="40" maxlength="50"></td></tr>';


  echo "<tr><td align='right'><span  class='subbld'><b>Current Log-in Username: &nbsp; </b></span></td><td>&nbsp;</td>\n";
  echo '<td align="left">' . $this->data['userid'] . '<input type="hidden" name="nuserid" value="' . $this->data['userid'] . '" ></td></tr>' . "\n";
  ...
  echo '<td align="left" height="50"><input type="text" name="grade_level" value="' . $this->data['grade_level'] . '" size="20" maxlength="25"></td></tr>' . "\n";

  if ($this->data['s_type'] == "school" || $this->data['s_type'] == "extended_school")
    {
  ...
  echo '<input type="hidden" name="s_type" value="' . $this->data['s_type'] . '">';
  echo '<input type="hidden" name="start_date" value="' . $this->data['start_date'] . '">'. "\n";
  ...
  echo '<input type="hidden" name="u_psw" value="' . $this->data['psw'] . '">';
  echo '<input type="hidden" name="nu_type" value="view">'. "\n";
  echo '<input type="hidden" name="nu_id" value="' . $this->data['u_id'] . '">';
  echo '<input type="hidden" name="nu_id1" value="' . $this->data['u_id'] . '">';
  echo '<input type="hidden" name="nuserid" value="' . $this->data['nuserid'] . '">';
  echo '<input type="hidden" name="renew" value="Y">';
  echo '<input type="hidden" name="s_type" value="' . $this->data['s_type'] . '">'. "\n";
?>
