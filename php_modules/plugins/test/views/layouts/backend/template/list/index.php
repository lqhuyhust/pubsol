				...
				<div class="col-12 p-0">
					<div class="card border-0 shadow-none">
                        ...
                        <div class="row align-items-center">
								<?php echo $this->render('backend.template.list.filter', []);?>
							</div>
							<form action="<?php echo $this->link_list ?>" method="POST" id="formList">
								...
								<table id="datatables-buttons" class="table table-striped border-top border-1" style="width:100%">
									...
									<tbody>
										<?php while($this->list->hasRow()) echo $this->render('backend.template.list.row', []); ?>
									</tbody>
								<?php
								?>
								</table>
...
<?php echo $this->render('backend.template.form', []);?>