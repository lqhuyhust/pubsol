<tr>
    ...
    <td>
        <form id="form_delete_<?php echo $this->item['id']; ?>" action="<?php echo $this->link_form. "/" .$this->item['id']; ?>" method="POST">
            ...
            <a href="<?php echo $this->link_form . '/' . $this->item['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
            <?php if ($this->user_id != $this->item['id']) { ?>
            <a class="button_delete_item" href="#" data-id_remove="<?php echo $this->item['id']; ?>"><i class="fa-solid fa-trash"></i></a>
            <?php } ?>
        </form>
    </td>
</tr>