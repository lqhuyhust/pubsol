    ...
    <div class="card col-lg-12" style="box-shadow: none;">
        <div class="card-body">
            ...
            <form enctype="multipart/form-data" action="<?php echo  $this->link_form . '/' . $this->id ?>" method="POST">
                <div class="row g-3 align-items-center">
                    <div class="mb-3 col-lg-12 col-sm-12 mx-auto">
                        ...
                        <div class="d-flex justify-content-center">
                            <?php if (isset($this->data['sub_hdr_img_url']) && $this->data['sub_hdr_img_url']) { ?>
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="mb-3 col-lg-12 col-sm-12 mx-auto">
                                <label class="form-label w-100 fw-bold text-start fs-5"><?php echo isset($this->data['sub_hdr_img_url']) && $this->data['sub_hdr_img_url'] ? "Replace this picture (.jpg or .gif):" :  "Load header picture:" ?></label>
                        ...
                        <div class="d-flex justify-content-center">
                            <?php if (isset($this->data['sub_img_url']) && $this->data['sub_img_url']) { ?>
                        ...
                        <div class="row g-3 align-items-center  py-3 ">
                            <div class="col-xl-12 col-sm-7 text-start ">
                                <label class="col-form-label fw-bold"><? echo (isset($this->data['sub_img_url']) && $this->data['sub_img_url']) ? "Replace This Menu Picture" : "Add New Menu Picture"; ?> (.jpg or .gif)</label> <br>
                ...
                for ($i = 0; $i < 7; $i++) {
                    $row = (isset($this->subject_image[$i]) && $this->subject_image[$i]) ?  $this->subject_image[$i] : [
                        'info_image_url' => '',
                        'id' => '',
                        'info_image' => '',
                        'info_sound' => '',
                                ...
                                <div class="row g-3 align-items-center py-3  border border-1">
                                    <div class="col-xl-6 col-sm-12 text-center">
                                        <?php if ($row['info_image_url']) { ?>
                                            <img style="max-width: 100%" name="subject_image_<? echo $row['info_text']; ?>" src="<? echo $row['info_image_url']; ?>" alt="<? echo $row['info_text']; ?>" border="1">
                                        <?php } else { ?>
                ...
                <div class="col-12">
                    ...
                    if ($this->subject_fact > 0) {
                        for ($fact_ct = 1; $fact_ct <= $fact_ct_max; $fact_ct++) {
                            # code...
                            $row = (isset($this->subject_fact[$fact_ct - 1 ]) && $this->subject_fact[$fact_ct - 1]) ? $this->subject_fact[$fact_ct - 1 ] : [
                                'id' => '',
                                'subject_id' => '',
                                'sort_order' => '',
                                'name' => '',
