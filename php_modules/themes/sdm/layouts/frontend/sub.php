                    ...
                    <form name="userupd1" action="<?php echo  $this->url ?>payment" method="post">
                        <div>
                            <div class="container">
                                ...
                                <div class="py-3">
                                    <?php if ($this->s_gift == "Yes") { ?>
                                        <div class="row g-3 align-items-center py-3">
                                            <div class="col-xl-5 col-sm-5 text-end">
                                                <label class="col-form-label fw-bold">Gift subscription given by:</label>
                                            </div>
                                            <div class="col-xl-3 col-sm-7 text-start ">
                                                <input class="form-control rounded-0 border border-1" type="text" name="gift_name" value="" maxlength="50">
                                            </div>

                                            <div class="col-xl-5 col-sm-5 text-end">
                                                <label class="col-form-label fw-bold">Email of gift subscription giver:</label>
                                            </div>
                                            <div class="col-xl-3 col-sm-7 text-start ">
                                                <input class="form-control rounded-0 border border-1" type="text" name="gift_name" value="" maxlength="50">
                                            </div>
                                ...
                                <div class="row g-3 align-items-center py-3">
                                    <?php if ($this->s_type == "home") { ?>
                                        <div class="col-xl-5 col-sm-5 text-end">
                                            <label class="col-form-label fw-bold">Email Address of New User:</label>
                                        </div>
                                    <?php } elseif ($this->s_type == "teacher") { ?>
                                        <div class="col-xl-5 col-sm-5 text-end">
                                    ...
                                    <?php } ?>
                                    <div class="col-xl-3 col-sm-7 text-start ">
                                        <input class="form-control rounded-0 border border-1" type="text" name="nu_email" value="" maxlength="50">
                                    </div>

                                    <div class="col-xl-5 col-sm-5 text-end">
                                        <label class="col-form-label fw-bold p-0">Preferred Log-in Username:</label>
                                        <p class="fs-7 mb-0">If your preferred username is not<br> available, your email address <br>will be assigned as your username. <br></p>
                                    </div>
                                    <div class="col-xl-3 col-sm-7 text-start ">
                                        <input class="form-control rounded-0 border border-1" type="text" name="nuserid" value="<?php echo  $this->data['nuserid'] ?> " maxlength="50">
                                    </div>
                                    <div class="col-xl-5 col-sm-5 text-end">
                                        <label class="col-form-label fw-bold p-0">Preferred User Password:</label>
                                        <p class="fs-7 mb-0">A default random password has <br>been created. You can change your <br>login password at this time if you like.<br></p>
                                    </div>
                                    <div class="col-xl-3 col-sm-7 text-start ">
                                        <input class="form-control rounded-0 border border-1" type="text" name="u_psw" value="<?php echo  $this->psw ?>" maxlength="50">
                                    </div>
                                    ...
                                    <?php } ?>
                                    <div class="col-xl-3 col-sm-7 text-start ">
                                        <input class="form-control rounded-0 border border-1" type="text" name="grade_level" value="<?php echo isset($this->data['grade_level']) ? $this->data['grade_level'] : ''; ?>" maxlength="50">
                                    </div>

                                    <?php if ($this->s_type == "school" || $this->s_type == "extended_school") { ?>
                                        <div class="col-xl-5 col-sm-5 text-end">
                                    ...
                                    <div>
                                        <div >
                                            <p>
                                                <input type="hidden" name="s_type" value="<?php echo  $this->s_type ?>">
                                                <?php $t_date = $this->data['start_date']; ?>
                                                <input type="hidden" name="start_date" value="<?php echo  $t_date ?>">
                                                ...
                                                <input type="hidden" name="nu_id" value="<?php echo  $this->data['nu_id'] ?>">
                                                <input type="hidden" name="nu_id1" value="<?php echo  $this->data['nu_id1'] ?>">
                                                <input type="hidden" name="s_type" value="<?php echo  $this->s_type ?>">
                                            </p>
